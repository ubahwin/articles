...
Я говорю о SwiftUI. Нравится вам это или нет – это будущее iOS разработки. И это
меняет правила игры с точки зрения задач, с которыми мы сталкиваемся при
проектировании архитектуры.

## Что концептуально меняется?

UIKit был **императивным,
[event-driven](https://ru.wikipedia.org/wiki/Событийно-ориентированная_архитектура)**
